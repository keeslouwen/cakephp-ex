...
<section class='container'>
          <hgroup>
            <h1>Welcome to your CakePHP application on Vancis Test OpenShift dd update: 2016.11.31 - 12:30 </h1>
          </hgroup>
...
$time += microtime(true);
echo "<p>Hash: $hash iterations:$i time: </p>",sprintf('%f', $time),PHP_EOL;
?>
          </section>
        </div>
